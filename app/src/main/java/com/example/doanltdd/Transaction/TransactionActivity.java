package com.example.doanltdd.Transaction;
...
public class TransactionActivity extends AppCompatActivity {
    ...
    private void setupBottomNavigationView(){
        ...
        BottomNavigationViewSetting.enableNavigation(TransactionActivity.this, bottomNavigationView);
    ...
    private void setupViewPager() {
        ...
        sectionsPagerAdapter.addFragment(new DayFragment()); // Ngày hôm kia
        sectionsPagerAdapter.addFragment(new DayFragment()); // Ngày hôm qua
        sectionsPagerAdapter.addFragment(new DayFragment()); // ngay hôm nay
